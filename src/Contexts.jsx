...
const Contexts = ({ children }) => {
  const [user, setUser] = useState({
    ...
    pulls: [
      {
        ProductName:
          "FALLING IN LOVE ON THE PATH TO HELL #3 CVR B 1:15 MIKE HAWTHORNE VAR\n1:15 Qualifying Variant",
        Category: "Q.VARIANTS",
        ItemCode: "0624IM293",
        ...
        "Qty.Ord.Late": "",
        ImageURL:
          "https://www.universaldist.com/api/v1/images/297585dd-d83f-4edf-af80-4ce1e526d793/raw?size=l",
        Publisher: "Image",
      },
      {
        ...
        "Qty.Ord.Late": "",
        ImageURL:
          "https://www.universaldist.com/api/v1/images/ac1d0631-fabd-4163-a8f1-94391f0f33b1/raw?size=l",
        Issue: "30",
        Publisher: "Image",
        ProductType: "Comic",
      ...
      },
      {
        ...
        "Qty.Ord.Late": "",
        ImageURL:
          "https://www.universaldist.com/api/v1/images/f8267c42-3c85-464b-9ba8-ba2d599b520b/raw?size=l",
        Issue: "30",
        Publisher: "Image",
        ProductType: "Comic",
      ...
      },
      {
        ...
        "Qty.Ord.Late": "",
        ImageURL:
          "https://www.universaldist.com/api/v1/images/bb628168-c200-432e-b803-2ebbd43390e1/raw?size=l",
        Issue: "3",
        Publisher: "Marvel",
        ProductType: "Comic",
      ...
      },
      {
        ...
        "Qty.Ord.Late": "",
        ImageURL:
          "https://www.universaldist.com/api/v1/images/1f849cda-eab7-4086-9e47-fec2398c705e/raw?size=l",
        Issue: "2",
        Publisher: "Image",
        ProductType: "Comic",
      ...
      },
      {
        ...
        "Qty.Ord.Late": "",
        ImageURL:
          "https://www.universaldist.com/api/v1/images/97fdb484-4915-4e57-8a9b-3eb9ce7c772f/raw?size=l",
        Issue: "357",
        Publisher: "Image",
        ProductType: "Comic",
      ...
      },
      {
        ...
        "Qty.Ord.Late": "",
        ImageURL:
          "https://www.universaldist.com/api/v1/images/a3df2d32-38b7-433c-bc65-66c2665a62d0/raw?size=l",
        Issue: "17",
        Publisher: "Idw",
        ProductType: "Comic",
  ...
  const [customers, setCustomers] = useState([
    {
      ...
      subList: [
        {
          skus: ["827714033151", "827714033359", "827714033168"],
      ...
      pulls: [
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/74675ca3-7282-46e5-aafa-692e760d2467/raw?size=l",
          Issue: "1",
          Publisher: "Marvel",
          ProductType: "Comic",
        ...
        },
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/9139dc5b-11fa-42c3-b2eb-24f0bbdd7734/raw?size=l",
          Issue: "1",
          Publisher: "Dc",
          ProductType: "Comic",
        ...
        },
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/f82a4c6e-c50a-4a57-8aa0-7574ae1507c7/raw?size=l",
          Issue: "1",
          Publisher: "Marvel",
          ProductType: "Comic",
      ...
      pulls: [
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/c4320781-2c8d-4e5f-ab83-83fd0bbb7bef/raw?size=l",
          Issue: "4",
          Publisher: "Marvel",
          ProductType: "Comic",
        ...
        },
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/befcf02b-e36f-47d2-a5d7-ba05b9e35260/raw?size=l",
          Issue: "6",
          Publisher: "Marvel",
          ProductType: "Comic",
          SeriesSku: "759606209088",
...

        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/647d3bc4-7e3c-4ac2-9800-df5878476b12/raw?size=l",
          Issue: "1",
          Publisher: "Marvel",
          ProductType: "Comic",
        ...
        },
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/ec2c8919-3cf4-4ca4-823b-bd0c7257f115/raw?size=l",
          Issue: "4",
          Publisher: "Dc",
          ProductType: "Comic",
        ...
        },
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/9b019c9a-2013-4c40-88f1-a930e5a3a26d/raw?size=l",
          Issue: "2",
          Publisher: "Marvel",
          ProductType: "Comic",
      ...
      pulls: [
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/060b7c90-8dd4-498b-aeb3-03ce117c3de8/raw?size=l",
          Issue: "5",
          Publisher: "Marvel",
          ProductType: "Comic",
        ...
        },
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/b370036f-3036-4fda-b2ba-1de195e29464/raw?size=l",
          Issue: "4",
          Publisher: "Image",
          ProductType: "Comic",
        ...
        },
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/b00b48d0-0b35-48e8-8134-b6a175b71cce/raw?size=l",
          Issue: "1",
          Publisher: "Image",
          ProductType: "Comic",
      ...
      pulls: [
        {
          ...
          "Qty.Ord.Late": "",
          ImageURL:
            "https://www.universaldist.com/api/v1/images/0ea3a369-805f-4a17-abbc-7122bf25e386/raw?size=l",
          Issue: "1",
          Publisher: "Marvel",
          ProductType: "Comic",
  ...
  const [messages, setMessages] = useState([
    {
      title: "Flash Sale",
      date: "June 8th, 2024",
      body: "All back issues are 50% for the weekend!",
      id: 10001,
    },
    {
      title: "Free Comic Book Day",
      date: "May 2nd, 2024",
      body: "Free Comic Book Day is this Saturday! Great sales storewide!",
      id: 10002,
    },
    {
      title: "New Back Issues",
      date: "April 21st, 2024",
      body: "New back issues have hit the floor",
      id: 10003,
    },
    {
      title: "Graphic Novel Sale",
      date: "April 20th, 2024",
      body: "All graphic novels are 30% off, this week only!",
      id: 10004,
    },
  ]);
